...
## No 2: Allstate Insurance Group (8) - Allstate Vehicle and Property Insurance Company (37907)
...
leaflet() %>%
  ...
  addLegend(pal = pal, values = values(nonhurr_ny), title = "Non-hHurricane Factor")
```
